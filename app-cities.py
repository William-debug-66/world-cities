...
st.header('analyzing tool')
st.subheader('conducted by William')
st.text('primary - country\'s capital (e.g. Washington D.C.)')
st.text('admin - first-level admin capital (e.g. Little Rock, AR)')
st.text('minor - lower-level admin capital (e.g. Fayetteville, AR)')
st.text('nan if not a capital (nan is not a string - it’s a keyword in Pandas for Null)')
